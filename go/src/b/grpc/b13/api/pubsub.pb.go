...
var file_pubsub_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x32, 0x5e, 0x0a, 0x0e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x53, 0x65,
	...
	0x67, 0x30, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: api.PublishService.Publish:input_type -> api.String
	0, // 1: api.PublishService.Subscribe:input_type -> api.String
	0, // 2: api.PublishService.Publish:output_type -> api.String
	0, // 3: api.PublishService.Subscribe:output_type -> api.String
...
func (c *publishServiceClient) Publish(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/api.PublishService/Publish", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *publishServiceClient) Subscribe(ctx context.Context, in *String, opts ...grpc.CallOption) (PublishService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PublishService_serviceDesc.Streams[0], "/api.PublishService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func _PublishService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.PublishService/Publish",
	}
...
var _PublishService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.PublishService",
