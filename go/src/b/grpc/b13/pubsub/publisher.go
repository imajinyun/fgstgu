...
// Allows to send events and subscribe to them.
...
// Publisher is basic pub/sub structure.
...
// Publish sends the data in v to all subscribes currently registered with the publisher.
...
// Close closes the channel to all subscribers registered with the publisher.
